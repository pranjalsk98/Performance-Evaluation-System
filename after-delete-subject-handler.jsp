	...
	<div class="container-fluid adminwindowblack">
		<div class="row">
			<div class="col-sm-12 addsubjectsbox">
				<p>
					<h1>Congratulations your subjects are deleted.</h1>
						<a href="st.jsp" class ="btn btn-success" role="button">See Subjects</a>
						<a href="del-subject.jsp" class="btn btn-danger" role="button">Delete More</a>
						<a href="adminwindow.jsp" class="btn btn-warning" role="button">Back</a>
				</p>
			</div>
		</div>
	</div>
