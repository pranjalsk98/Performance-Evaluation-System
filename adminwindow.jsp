	...
	<div class="container-fluid adminwindowblack">
        <div class="row">
			...
			<div class="col-sm-4 adminwindowcol">
				<h3>Add Subject</h3>
				<a href="add-subject.jsp" class="btn btn-dark" role="button">Proceed</a>
			</div>
			<div class="col-sm-4 adminwindowcol">
		...
		<div class="row">
			<div class="col-sm-4 adminwindowcol">
				<h3>Add Question</h3>
				<a href="add-question1.jsp" class="btn btn-dark" role="button">Proceed</a>
			</div>
			<div class="col-sm-4 adminwindowcol">
		...
		<div class="row">
			...
			<div class="col-sm-4 adminwindowcol">
				...
				<a href="st.jsp" class="btn btn-dark" role="button">Proceed</a>
			</div>
			<div class="col-sm-4 adminwindowcol">
