...
ResultSet rs=st.executeQuery("select * from "+sub+"where sno="+sno+";");
while(rs.next()){
	%>
	<div class="row">
						<div class="col-sm-2"></div>
						<div class="col-sm-8 question" style="font-size: 40px;">
					...
					<div class="row">
						<div class="col-sm-2"></div>
						<div class="col-sm-4 option" style="font-size: 25px;">
					...
					<form action="update-question-handler.jsp?sub=<%=sub %>&sno=<%=sno%>" method="post">
						<span>Enter option number to update.Enter 'q' to update question.Enter 'c' to update correct answer:</span>
